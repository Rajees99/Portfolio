      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi There, <br />I'm Segar <span className='text-sky-400'>RajeesKumar</span></h1>
               <p className='md:text-2xl text-xl mb-4'>Web Developer & Designer</p>
               <p className='mb-4'>I'm an enthusiastic web developer with proficiency in React, Next.js, and cutting-edge web technologies. I enjoy building visually appealing and highly functional websites that tackle real world issues.</p>
               <button className='bg-black text-white px-3 py-2 w-max rounded-md'><a href="Rajees - Resume.pdf" download target='Rajees - Resume.pdf'>Download CV</a></button>
            </div>
