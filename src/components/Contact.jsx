    ...
    <section id='contact' className='z-50 bg-gray-800 relative py-10 px-5 md:px-0'>
      <div className='mb-16 max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row justify-between items-center'>
            ...
            <form className='w-full md:w-1/2 bg-gray-100 rounded-lg border border-sky-200 shadow-lg shadow-sky-400 p-10'> 
              ...
              <button className='bg-sky-400 text-white px-3 py-2 rounded-lg'>Send Message</button>
            </form>
        </div>
      </div>
    </section>
